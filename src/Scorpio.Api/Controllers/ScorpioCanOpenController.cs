...
namespace Scorpio.Api.Controllers
{
    ...
    public class ScorpioCanOpenController : ControllerBase
    {
        private readonly ICanOpenObjectRepository _scorpioCanOpenObjectRepository;
        private readonly IEventBus _eventBus;

        public ScorpioCanOpenController(IScorpioCanOpenObjectRepository openObjectRepository, IEventBus eventBus)
        {
            _scorpioCanOpenObjectRepository = openObjectRepository;
            _eventBus = eventBus;
        }
